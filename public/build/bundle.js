...
var app = (function () {
    ...
    // (84:4) <Button backgroundColor="var(--theme-secondary)" width="12em" outline on:click={()=>{ modal.create = true;  }}>
    function create_default_slot_12(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(84:4) <Button backgroundColor=\\\"var(--theme-secondary)\\\" width=\\\"12em\\\" outline on:click={()=>{ modal.create = true;  }}>",
    		ctx
    	});
    ...
    // (100:28) <Button width="8em" outline on:click={()=>{ modal.update = true; selectedUser = row }}>
    function create_default_slot_11(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(100:28) <Button width=\\\"8em\\\" outline on:click={()=>{ modal.update = true; selectedUser = row }}>",
    		ctx
    	});
    ...
    // (101:28) <Button width="8em" outline on:click={()=>{ modal.delete = true;  modal.target = i; selectedUser = row }} }}>
    function create_default_slot_10(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(101:28) <Button width=\\\"8em\\\" outline on:click={()=>{ modal.delete = true;  modal.target = i; selectedUser = row }} }}>",
    		ctx
    	});
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(td0, file$b, 97, 12, 2341);
    			attr_dev(td1, "width", "8em");
    			add_location(td1, file$b, 99, 12, 2400);
    			attr_dev(td2, "width", "8em");
    			add_location(td2, file$b, 100, 12, 2537);
    			add_location(tr, file$b, 96, 8, 2323);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(96:4) {#each data as row, i}",
    		ctx
    	});
    ...
    function create_default_slot_9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$b, 81, 0, 1746);
    			attr_dev(th0, "class", "sort");
    			attr_dev(th0, "data-sort", "email");
    			add_location(th0, file$b, 88, 12, 2125);
    			add_location(th1, file$b, 89, 12, 2184);
    			add_location(th2, file$b, 90, 12, 2213);
    			add_location(tr, file$b, 87, 8, 2107);
    			add_location(thead, file$b, 86, 4, 2090);
    			attr_dev(tbody, "class", "list");
    			add_location(tbody, file$b, 93, 4, 2263);
    			add_location(table, file$b, 85, 0, 2076);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(81:0) <Table  options={settings}>",
    		ctx
    	});
    ...
    // (113:8) <Button width="100%" backgroundColor="var(--theme-primary)" style="margin-right:2em;" on:click={handleCreate}>
    function create_default_slot_8(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(113:8) <Button width=\\\"100%\\\" backgroundColor=\\\"var(--theme-primary)\\\" style=\\\"margin-right:2em;\\\" on:click={handleCreate}>",
    		ctx
    	});
    ...
    // (114:8) <Button width="100%" outline on:click={()=>{ modal.hide() }}>
    function create_default_slot_7(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(114:8) <Button width=\\\"100%\\\" outline on:click={()=>{ modal.hide() }}>",
    		ctx
    	});
    ...
    // (109:0) <Modal bind:visible={modal.create} style="display:flex;flex-direction:column;width:40vw;min-width:280px;border-radius:0.5em;padding:4em">
    function create_default_slot_6(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(109:0) <Modal bind:visible={modal.create} style=\\\"display:flex;flex-direction:column;width:40vw;min-width:280px;border-radius:0.5em;padding:4em\\\">",
    		ctx
    	});
    ...
    // (122:8) <Button width="100%" backgroundColor="var(--theme-primary)" style="margin-right:2em;" on:click={handleUpdate}>
    function create_default_slot_5(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(122:8) <Button width=\\\"100%\\\" backgroundColor=\\\"var(--theme-primary)\\\" style=\\\"margin-right:2em;\\\" on:click={handleUpdate}>",
    		ctx
    	});
    ...
    // (123:8) <Button width="100%" outline on:click={()=>{ modal.hide() }}>
    function create_default_slot_4(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(123:8) <Button width=\\\"100%\\\" outline on:click={()=>{ modal.hide() }}>",
    		ctx
    	});
    ...
    // (118:0) <Modal bind:visible={modal.update} style="display:flex;flex-direction:column;width:40vw;min-width:280px;border-radius:0.5em;padding:4em">
    function create_default_slot_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(button1.$$.fragment);
    			attr_dev(h3, "class", "svelte-1mn61rz");
    			add_location(h3, file$b, 118, 4, 3575);
    			set_style(div, "display", "flex");
    			set_style(div, "flex-direction", "row");
    			set_style(div, "justify-content", "space-around");
    			add_location(div, file$b, 120, 4, 3777);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h3, anchor);
    			insert_dev(target, t1, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(118:0) <Modal bind:visible={modal.update} style=\\\"display:flex;flex-direction:column;width:40vw;min-width:280px;border-radius:0.5em;padding:4em\\\">",
    		ctx
    	});
    ...
    // (130:8) <Button width="100%" backgroundColor="var(--theme-primary)" style="margin-right:2em;" on:click={handleDelete}>
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(130:8) <Button width=\\\"100%\\\" backgroundColor=\\\"var(--theme-primary)\\\" style=\\\"margin-right:2em;\\\" on:click={handleDelete}>",
    		ctx
    	});
    ...
    // (131:8) <Button width="100%" outline on:click={()=>{ modal.hide() }}>
    function create_default_slot_1$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(131:8) <Button width=\\\"100%\\\" outline on:click={()=>{ modal.hide() }}>",
    		ctx
    	});
    ...
    // (127:0) <Modal bind:visible={modal.delete} style="display:flex;flex-direction:column;width:40vw;min-width:280px;border-radius:0.5em;padding:4em">
    function create_default_slot$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(button1.$$.fragment);
    			attr_dev(h3, "class", "svelte-1mn61rz");
    			add_location(h3, file$b, 127, 4, 4247);
    			set_style(div, "display", "flex");
    			set_style(div, "flex-direction", "row");
    			set_style(div, "justify-content", "space-around");
    			add_location(div, file$b, 128, 4, 4273);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h3, anchor);
    			insert_dev(target, t1, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(127:0) <Modal bind:visible={modal.delete} style=\\\"display:flex;flex-direction:column;width:40vw;min-width:280px;border-radius:0.5em;padding:4em\\\">",
    		ctx
    	});
